  ...
  return (
    <section id="hero" className="min-h-screen flex items-center justify-center relative overflow-hidden pt-16">
      ...
      <div className="w-full px-6 lg:px-8 text-center">
        ...
        <h1 className="text-4xl md:text-5xl lg:text-6xl tracking-tight mb-8 max-w-4xl mx-auto leading-tight animate-fade-in" style={{ animationDelay: '0.1s' }}>
        ...
        <p className="text-lg md:text-xl text-muted-foreground max-w-3xl mx-auto animate-fade-in leading-relaxed" style={{ animationDelay: '0.2s' }}>
          While your competitors chase the same tired referrals, you're about to access an exclusive pipeline of liquidity-rich business owners who actually need your expertise.
        </p>
