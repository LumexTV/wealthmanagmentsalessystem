    ...
    <footer className="relative bg-gradient-to-b from-slate-50 to-white border-t border-slate-200 overflow-hidden">
      ...
      <div id="contact" className="py-20 lg:py-24 scroll-mt-20">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center overflow-visible">
          <h3 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 leading-[1.1] pb-1 bg-gradient-to-r from-slate-900 to-slate-700 bg-clip-text text-transparent">
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="grid md:grid-cols-3 gap-10 lg:gap-12">
            ...
            <div className="text-center">
              <h4 className="font-semibold text-slate-900 mb-5">Connect</h4>
              <ul className="space-y-3 text-sm">
                <li><a href="mailto:luka@marticsolutions.com" className="text-slate-600 hover:text-slate-900 transition-colors">Contact Us</a></li>
                <li><a href="https://cal.com/marticsolutions/intro-call-40mins" className="text-slate-600 hover:text-slate-900 transition-colors">Strategy Call</a></li>
              </ul>
            </div>
            {/* Martic Solutions (Middle) */}
            <div className="text-center md:border-l md:border-slate-200 md:pl-10">
              <h4 className="font-semibold text-slate-900 mb-5">Martic Solutions</h4>
            ...
            {/* Services (Right) */}
            <div className="text-center md:border-l md:border-slate-200 md:pl-10">
              <h4 className="font-semibold text-slate-900 mb-5">Services</h4>
              <ul className="space-y-3 text-sm">
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex gap-6 text-sm">
              <a href="/legal-notice" className="text-slate-600 hover:text-slate-900 transition-colors">Legal Notice</a>
              <a href="/privacy-policy" className="text-slate-600 hover:text-slate-900 transition-colors">Privacy</a>
              <a href="/terms" className="text-slate-600 hover:text-slate-900 transition-colors">Terms</a>
            </div>
          </div>
        </div>
      </div>
